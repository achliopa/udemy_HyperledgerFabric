...
export CORE_PEER_LISTENADDRESS=127.0.0.1:$VAR
export CORE_PEER_ADDRESS=127.0.0.1:$VAR
VAR=$((PORT_NUMBER_BASE+2))
export CORE_PEER_CHAINCODELISTENADDRESS=127.0.0.1:$VAR
VAR=$((PORT_NUMBER_BASE+3))
export CORE_PEER_EVENTS_ADDRESS=127.0.0.1:$VAR
